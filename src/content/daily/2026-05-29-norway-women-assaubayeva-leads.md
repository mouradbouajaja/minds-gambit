...
sourceUrl: "https://en.chessbase.com/post/norway-chess-women-4"
lead: true
pinned: false
draft: false
standingsTitle: "Women — Standings after Round 4"
standings:
  - { player: "Bibisara Assaubayeva", score: "7" }
  - { player: "Zhu Jiner", score: "5½" }
  - { player: "Anna Muzychuk", score: "5½" }
  - { player: "Divya Deshmukh", score: "5½" }
  - { player: "Ju Wenjun", score: "4" }
  - { player: "Humpy Koneru", score: "3" }
---

The women's event in Oslo has stayed remarkably tight, with the scoring system meaning a single classical win can still reshape the table over the six rounds that remain. For full coverage, follow the link to ChessBase's report.
